// VITE_API_URL is the backend origin (e.g. http://localhost:3001 in dev,
// https://your-backend.railway.app in production).
// The /api prefix is appended here so only the origin needs to be configured.
